    ...
    methods: {
        ...
        focusLabel(focus) {
            ...
            if ( !this.autofill ){
                ...
                if ((this.modelValue !== null) && (this.modelValue !== undefined) && (this.modelValue.length === 0)) {
        ...
        initialLabel(vparent) {
            if (this.vmodel) {
                let dotget = Helpers.dotget(vparent, this.vmodel)
                return dotget === undefined || dotget === null || dotget.length === 0
            }
