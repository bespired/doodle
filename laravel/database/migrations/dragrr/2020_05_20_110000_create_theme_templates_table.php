...
class CreateThemeTemplatesTable extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::dropIfExists('templated_themes');

        Schema::create('templated_themes', function (Blueprint $table) {
            ...
            $table->longText('fcc')->nullable()->comment('forced cascading classes');
            $table->longText('draw')->nullable();
            $table->softDeletes();
            $table->timestamps();
        });

        Schema::table('templated_themes', function (Blueprint $table) {
